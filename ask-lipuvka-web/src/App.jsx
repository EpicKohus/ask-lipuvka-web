...
export default function AskLipuvkaWeb() {
  ...
  const matches = [
    ...
    },
    {
      ...
      home: true,
      result: 'doplnit',
      articleTitle: 'Krátké hodnocení zápasu',
      article:
        'Sem můžeš napsat krátký článek k zápasu. Například průběh utkání, nejlepší momenty, střelce branek nebo pochvalu pro tým.',
      photos: ['/field.png'],
    },
    {
      date: '9. 4. 2026',
      ...
      home: true,
      result: 'doplnit',
      articleTitle: 'Shrnutí utkání',
      article:
        'Tady může být krátký článek po zápase. Stačí přepsat text podle skutečného průběhu utkání.',
      photos: ['/field.png'],
    },
    {
      date: '14. 4. 2026',
      ...
      home: false,
      result: 'doplnit',
      articleTitle: 'Komentář trenéra',
      article:
        'Sem můžeš přidat krátký komentář trenéra, zhodnocení výkonu nebo informace pro rodiče.',
      photos: ['/field.png'],
    },
    {
      date: '23. 4. 2026',
      ...
      home: true,
      result: 'doplnit',
      articleTitle: 'Report ze zápasu',
      article:
        'Sem můžeš dát krátký report ze zápasu a případně doplnit zajímavosti nebo pochvalu hráčům.',
      photos: ['/field.png'],
    },
  ];
    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section id="zapasy" className="mx-auto max-w-5xl px-6 py-14">
        <div className="mb-6">
          ...
          <p className="text-gray-600">U každého zápasu můžeš doplnit výsledek, článek i fotky.</p>
        </div>
