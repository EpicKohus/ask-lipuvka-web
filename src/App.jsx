      ...
      <section className="mx-auto max-w-5xl px-6 pb-10">
        <div className="rounded-2xl bg-gray-50 p-6 text-center shadow-sm">
          ...
          <p className="text-gray-700">
            Mládežnické týmy ASK Lipůvka zahrnují předpřípravku (U7), mladší přípravku (U9) a starší přípravku (U11). Mladší přípravka se účastní soutěží a od příští sezony budeme mít dva týmy v soutěžích U9 a U11.
          </p>
