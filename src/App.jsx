...
import { addDoc, collection, doc, getDocs, getDoc, runTransaction, serverTimestamp } from 'firebase/firestore';
...
export default function AskLipuvkaWeb() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <header className="sticky top-0 z-20 border-b bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <nav className="hidden gap-6 text-sm md:flex">
            ...
            <a href="#merch" className="hover:text-green-600">Merch</a>
      ...
      <section id="merch" className="bg-white px-6 py-14">
        <div className="mx-auto max-w-6xl">
          <div className="mb-8 text-center">
            ...
            <h2 className="text-3xl font-black text-green-700 md:text-4xl">
          ...
          <form onSubmit={handleSubmitMerch} className="space-y-6">
                ...
                <div key={product.id} className="rounded-3xl border border-green-100 bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
                  ...
                  <div className="mt-3 grid gap-3 sm:grid-cols-2">
                    <label className="block">
                      ...
                      <input type="text" name={`${product.id}_customName`} placeholder="např. MÁNEK" className="w-full rounded-xl border border-gray-300 bg-white px-3 py-3 text-gray-900 outline-none focus:border-green-500 focus:ring-2 focus:ring-green-200" />
                    </label>
            ...
            <div className="rounded-3xl border border-green-100 bg-green-50/60 p-5 shadow-sm md:p-6">
              <h3 className="mb-4 text-2xl font-black text-green-700">Kontaktní údaje</h3>
